...
这条执行成功
mvn exec:java "-Dexec.mainClass=top.guoziyang.mydb.backend.Launcher" "-Dexec.args=-create D:/Code/MYDB/tmp/mydb"
```
...
执行成功
mvn exec:java "-Dexec.mainClass=top.guoziyang.mydb.backend.Launcher" "-Dexec.args=-open D:/Code/MYDB/tmp/mydb"
```
